...
> **Copied from commit:** `70b550f` (`master`) - config.request.schema.json's "Kit" field (roadmap #149) was the one file that had drifted; the other 6 were already current
